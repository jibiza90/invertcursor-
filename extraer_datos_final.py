...
def procesar_hoja(nombre_hoja):
    ...
    for numero_cliente, grupo_columnas in clientes_columnas.items():
        ...
        for fila_idx in range(15, ws.max_row + 1):
            ...
            # IMPORTANTE: Incrementos desde K15, Decrementos desde L15
            ...
            if fila_idx >= 15:
                if incremento is not None:
                    try:
                        ...
                        if inc_val != 0:  # Solo contar valores no cero
                ...
                if decremento is not None:
                    try:
                        ...
                        if dec_val != 0:  # Solo contar valores no cero
        ...
        if saldos_finales:
            ...
            if cliente_data['saldo_actual'] is None and saldos_finales:
